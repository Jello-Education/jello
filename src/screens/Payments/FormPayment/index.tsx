...
const index = () => {
    ...
    <ContainerInput>
      ...
      <Title>Falta pouco para você <br /> começar a estudar!</Title>
      <DescriptionTop>Escolha a melhor forma de pagamento para você.</DescriptionTop>

      <ContainerFormPayment>

          {formPaymethod == 1 ? <div style={{ color: "#44f9bd", marginRight: "5%", marginTop: "3%"}} ><AiFillCreditCard /></div> : <div style={{ color: "#FD3373", marginRight: "5%", marginTop: "3%" }} onClick={() => setFormPaymethod(1)} ><AiFillCreditCard /></div>}

          {formPaymethod == 2 ? <div style={{ color: "#44f9bd", marginRight: "5%", marginTop: "3%" }} ><RiBarcodeBoxLine /></div> : <div style={{ color: "#FD3373", marginRight: "5%", marginTop: "3%" }} onClick={() => setFormPaymethod(2)} ><RiBarcodeBoxLine /></div>}

          {formPaymethod == 3 ? <IconPayment src={Pix2} /> : <IconPayment onClick={() => setFormPaymethod(3)} src={Pix} />}

          {formPaymethod == 4 ? <IconPayment src={PicPay2} /> : <IconPayment onClick={() => setFormPaymethod(4)} src={PicPay} />}
    ...
    {formPaymethod == 2 &&
      ...
      <div style={{ display: 'grid', justifyContent: 'center' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }} >
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: "3%", width: "40%"}} >
        ...
        <ContainerInputFlex>
          <div>
            ...
            <InputFlex style={{ marginRight: 20}} type="text" placeholder="0000" />
          </div>
    ...
    {formPaymethod == 3 &&
      ...
      <div style={{ display: 'grid', justifyContent: 'center' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }} >
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: "3%", width: "50%"}} >
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginRight: "3%", width: "100%"}} >
    ...
    {formPaymethod == 4 &&
      ...
      <ContainerPrivacity>
        ...
        <Description>
            Aceito os <strong style={{ color: '#FD3373' }}>Termos de Serviço e Política de Privacidade.</strong>
        </Description>
      </ContainerPrivacity>
